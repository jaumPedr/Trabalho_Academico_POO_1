...
public class Final{
	...
	public static void main(int num1, int num2) throws InterruptedException {
		...
		System.out.println("\nPOSIÇÃO INICIAL DO ROBÔ " + robo1.getCor() + ": (" + robo1.getX() + ", " + robo1.getY() + ")");
		robo1.mostrarMatriz(xAlim, yAlim);
		System.out.println("-----------------------------------\n");
		
		System.out.println("\nPOSIÇÃO INICIAL DO ROBÔ " + robo2.getCor() + ": (" + robo2.getX() + ", " + robo2.getY() + ")");
		robo2.mostrarMatriz(xAlim, yAlim);
		System.out.println("-----------------------------------");
	...
	public static void visualizar(Robo robo, Robo outro) {
		System.out.println("\n");
		System.out.println("POSIÇÃO DO ROBÔ NORMAL: (" + robo.getX() + ", " + robo.getY() + ")");
		//System.out.println("Número de movimentos do Robô Normal: " + robo.getQuantMoves());
		System.out.println("\nPOSIÇÃO DO ROBÔ INTELIGENTE: (" + outro.getX() + ", " + outro.getY() + ")");
		//System.out.println("Número de movimentos do Robô Inteligente: " + outro.getQuantMoves());
